        ...
        <div class="card-body">
                ...
                <div class="form-row">
                    <div class="col">
                        ...
                        <form method="POST" action="{{route('modificar.update', $modificar -> id)}}">
                            @csrf
                            @method('PUT')
            ...
            <a class="btn btn-primary" role="button" href="{{route('modificar.create')}}" style="margin-top: 15px;margin-left: 8px;background-color: rgb(207,90,82);"> Cancelar </a>
        </div>
        </form>
