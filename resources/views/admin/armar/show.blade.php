                ...
                <table class="table dataTable my-0" id="dataTable">
                    <thead>
                        <tr>
                            ...
                            <th>Material de Carcasa</th>
                            <th>Color de Carcasa</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td class="text-center">{{ $armar -> id_user}}</td>
                            <td class="text-center">{{ $armar -> estado}}</td>
                            <td class="text-center">{{ $armar -> modelo_switches }}</td>
                            <td class="text-center">{{ $armar -> material_keycaps}}</td>
                            <td class="text-center">{{ $armar -> color_keycaps}}</td>
                            <td class="text-center">{{ $armar -> material_carcasa}}</td>
                            <td class="text-center">{{ $armar -> color_carcasa}}</td>
                    </tbody>
                    <tfoot>
                        <tr>
                            <th>ID Usuario</th>
