        ...
        <div class="card-body">
            ...
            <div class="form-row">
                <div class="col">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{route('armar.store')}}">
                        @csrf
                        ...
                        <div class="x-dropdown dropdown">
                            ...
                            <select name="material_carcasa" class="border rounded-0 shadow-sm text-left x-drop-btn"
                                data-toggle="dropdown" aria-expanded="false"
                                style="margin-bottom: 22px;filter: grayscale(0%);">
                                <i class="material-icons">keyboard_arrow_down</i>
                        ...
                        <div class="x-dropdown dropdown">
                            ...
                            <select name="color_carcasa" class="border rounded-0 shadow-sm text-left x-drop-btn"
                                data-toggle="dropdown" aria-expanded="false"
                                style="margin-bottom: 22px;filter: grayscale(0%);">
                                <i class="material-icons">keyboard_arrow_down</i>
                                <option value="Negro<" class="dropdown-item" role="presentation">Negro</option>
            ...
            <a class="btn btn-primary" role="button" href="{{route('armar.index')}}"
